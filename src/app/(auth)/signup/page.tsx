	...
	<div className="h-screen grid place-items-center">
		<div className="flex flex-col gap-6 p-8 rounded-md bg-white max-w-[400px] w-full">
			...
			<div className="flex flex-col gap-2">
				...
				<input className="border p-1 rounded-md outline-none border-border100 focus:outline-1 focus:outline-bg100 focus:outline-solid" type="password" name="confirmPassword" id="signup_confirm_password" />
			</div>
			<div className="flex flex-col gap-2">
				<button className="border border-border100 py-2 bg-bg100 rounded-md text-bgMain">Sign up</button>
				<div className="flex justify-between items-center">
					<span className="text-sm text-bg100">Already have an account?</span>
					<Link className="underline text-sm text-bg100" href='/login'>Login</Link>
				</div>
			</div>
		</div>
	</div>
